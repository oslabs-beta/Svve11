...
<div class="main-contanier">
  <p>
    "Your website is only as strong as your weakest component!"<em
      >-Arnold Schwarzenegger</em
    >
  </p>
</div>
...
<fieldset id="buttons">
  ...
  <Button
    ...
    handleClick={(event) =>
      alert(
        `Some event or action has been activated by button (id: ${event.target.id}).`
      )}
  />
</fieldset>
