...
import { render, getByRole, getByAltText, getAllByAltText, getAllByRole } from '@testing-library/svelte';
  ...
  contentInfo: [
      {
        ...
        links: [
          "../routes/pages/button.svelte", "../routes/pages/accordion.svelte"
        ]
      }
    ],
  imgSrc: '../images/svvell-logo-yellow.png',
