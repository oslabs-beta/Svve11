<script lang="ts">
	...
	import type { optionsTypes, accordionStylesObjectTypes } from './Accordion/AccordionTypes';
	...
	let styles: accordionStylesObjectTypes;
	$: styles;
	...
	onMount(() => {
		...
		for (let i = 0; i < options.panelInfo.length; i++) panelStates = [...panelStates, false];
	});
